...
class AdminBookController extends Controller
{
    public function index()
    {
        ...
        return view('admin.pengelolaan-buku.buku', compact('books', 'pengunjungs'));
    }

    public function create()
    {
        return view('admin.pengelolaan-buku.tambah');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pengelolaan-buku.edit', compact('book'));
    }
    ...
    public function import(Request $request)
    {
        ...
        return redirect()->route('admin.buku')->with('success', 'Buku berhasil diimport.');
    }
