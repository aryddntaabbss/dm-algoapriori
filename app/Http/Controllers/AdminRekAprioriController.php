...
class AdminRekAprioriController extends Controller
{
    /**
    ...
    {
        return view('admin.rek-apriori.index');
    }
    ...
    public function process(Request $request)
    {
        ...
        return view('admin.rek-apriori.index', compact('aprioriResult', 'transactions'));
    }
